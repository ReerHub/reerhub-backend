...
<div class="container">
  ...
  <div class="content">
    ...
    <p class="text">Thanks for signing up! Please verify your email address <span class="user-email">${email}</span> to get started.</p>
    
    <!-- Big Action Button -->
    <a href="${verifyUrl}" target="_blank" class="btn">Verify Email</a>

    <p class="text" style="font-size: 13px;">This link will expire soon.</p>
